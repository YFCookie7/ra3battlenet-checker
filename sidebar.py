...
class sidebar(ctk.CTkFrame):
    def __init__(self, parent):
        ...
        self.lb_logo = ctk.CTkLabel(self, text="RA3 BattleNet", font=ctk.CTkFont(size=20, weight="bold"))
        ...
        self.menu_scaling = ctk.CTkOptionMenu(
            ...
            command=lambda scaling:ctk.set_widget_scaling((int(scaling.replace("%", "")) / 100)),
        )
